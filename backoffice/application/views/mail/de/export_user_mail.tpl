...
<div style="width:80%;padding:40px;border: solid 10px #D0D0D0;margin:50px auto;">
    <div style="width:100%;margin:15px 0 0 0;">
        ...
        <p style="font: normal 12px Tahoma, Geneva, sans-serif;text-align:justify;color:#212121;line-height:23px;">
            Vielen Dank, dass Sie an SWISSCOIN teilnehmen. Für Sie wurde Account auf unserer Seite Academy eingerichtet.
        </p>
        <p style="font: normal 12px Tahoma, Geneva, sans-serif;text-align:justify;color:#212121;line-height:23px;">
            Hier können Sie sich mit Ihrem Usernamen und dem unten stehenden generiertem Passwort auf der Academy einloggen.
        </p>
        <p style="font: normal 12px Tahoma, Geneva, sans-serif;text-align:justify;color:#212121;line-height:23px;">
            Direkter Link zur Academy: <a href="http://goo.gl/XooQm7">Click Here</a></font>
        </p>
        <p style="font: normal 12px Tahoma, Geneva, sans-serif;text-align:justify;color:#212121;line-height:23px;">
            Link über Backoffice zur Academy: <a href="goo.gl/s9DhLa">Click Here</a></font>
        </p>
        <div style="width:400px;height:225px;margin:16px auto;border: solid 1px #d0d0d0;border-radius: 10px; clear: both;">
            ...
            <ul style="display:block;margin:14px 0 0 -36px;float:left;">
                ...
                <li style="list-style:none;font:normal 15px Tahoma, Geneva, sans-serif;color:#212121;margin:5px 0 0 20px;border:1px solid #ccc;background:#fff;width:300px;padding:5px;"><span style="width:150px;float:left;">Ihre Username</span><font color="#e10000"> : {$user->user_name}</font></li>
                <li style="list-style:none;font:normal 15px Tahoma, Geneva, sans-serif;color:#212121;margin:5px 0 0 20px;border:1px solid #ccc;background:#fff;width:300px;padding:5px;"><span style="width:150px;float:left;">Ihre Passwort</span><font color="#e10000"> : {$password}</font></li>
            </ul>
        </div>
        <div style="clear: both;"></div>
        <p style="font: normal 12px Tahoma, Geneva, sans-serif;text-align:justify;color:#212121;line-height:23px;">
            Nach Eingabe des generierten Passwort´s vergessen Sie bitte nicht, dies zu ändern.
        </p>
        <p style="font: normal 12px Tahoma, Geneva, sans-serif;text-align:justify;color:#212121;line-height:23px;">
            Ihr SWISSCOIN-Team
        </p>
