    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                {form_open('auto_register/register_submit', 'role="form" class="smart-wizard form-horizontal" method="post"  name="form" id="form"')}
                    ...
                    <div id="wizard" class="swMain">
                        ...
                        <div id="step-2">
                            ...
                            <hr>                            
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="user_count">User Count:<font color="#ff0000">*</font></label>
                                <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input   tabindex="17" type="text"   name="address" id="address"  maxlength="128"autocomplete="Off"  class="form-control" {if isset($reg_post_array['address'])} value="{$reg_post_array['address']}" {/if} >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input  tabindex="26" name="mobile" id="mobile" type="text" autocomplete="Off" class="form-control" maxlength="10" {if $reg_count>0} value="{$reg_post_array['mobile']}" {/if} >
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-7" for="">    
                                    ...
                                    <label class="checkbox-inline">
                                        <input name="agree" id="agree"  type="checkbox" value="" tabindex="32">
