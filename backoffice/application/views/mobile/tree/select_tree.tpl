    ...
    var UITreeview = function() {
        ...
        var runTreeView = function() {
            ...
            $("#tabular_tree").dynatree({
                initAjax: {
                    url: "{$BASE_URL}mobile/tree/get_children/{$user_id}"
                                    },
                                    onLazyRead: function(node) {
                                        node.appendAjax({ url: "{$BASE_URL}mobile/tree/get_children/{$user_id}"
                                                            });
                                                        },
                                                        onActivate: function(node) {
                                                            node.appendAjax({ url: "{$BASE_URL}mobile/tree/get_children/" + node.data.id
                                                            });
                                                        },
