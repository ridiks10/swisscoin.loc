...
<html lang="en" class="no-js">
    ...
    <body  class="{if $CURRENT_CTRL =='login'}login example2{/if}" >
        ...
        {if $SESS_STATUS} 
            {include file="admin/layout/themes/default/auto_timeout.tpl" title="Example Smarty Page" name=""}
            <!--site header-->	
            {include file="admin/layout/themes/default/site_header.tpl" title="Example Smarty Page" name=""}
            <!--site header-->            
        {/if}
