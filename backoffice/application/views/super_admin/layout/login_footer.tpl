...
<!-- start: Grid files -->
{*<link href="{$PUBLIC_URL}plugins/select2/select2.min.js">
<link href="{$PUBLIC_URL}plugins/DataTables/media/js/jquery.dataTables.min.js">
<link href="{$PUBLIC_URL}plugins/DataTables/media/js/DT_bootstrap.js">*}
