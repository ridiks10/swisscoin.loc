...
/*# sourceMappingURL=bootstrap-theme.css.map */</style>
	<style>/* ==== Google font ==== */
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-12">
					<h1>SWISSCOIN</h1>
					<h2 class="subtitle">Site Under Construction, Sorry for any inconvenience caused.</h2>
                                        <h3 class="subtitle" style="color:white;">We're working hard to improve our website</h3>
