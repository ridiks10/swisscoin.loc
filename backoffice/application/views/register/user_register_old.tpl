            ...
            <div class="panel-body">
                ...
                <div id="wizard" class="swMain">
                        ...
                        <li>
                            <a href="#step-1">
                                ...
                                <span class="stepDesc"> {lang('step1')} 
                                    <br />
                                    <small>{lang('sponser_and_package_information')} </small> 
                                </span>
                            </a>
                        </li>
                        <li>
                    ...
                    <div id="step-1">
                        ...
                        <h2 class="StepTitle">{lang('sponser_and_package_information')}</h2>

                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="sponsor_user_name">{lang('sponsor_user_name')}:<font color="#ff0000">*</font></label>
                            <div class="col-sm-7">
                        ...
                        {if $reg_from_tree && $MLM_PLAN != "Unilevel"} 
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="placement_user_name">{lang('placement_user_name')}:<font color="#ff0000">*</font></label>
                                <div class="col-sm-7">
                        ...
                        {if $MODULE_STATUS['product_status'] == "yes"}
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="product_id">{lang('product')}:<font color="#ff0000">*</font></label> 
                                <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            <div class="col-sm-2 col-sm-offset-3">
                                <button tabindex="7" class="btn btn-blue next-step btn-block" id="next_1" disabled>
                    ...
                    <div id="step-2">
                        ...
                        {if {$user_name_type}!="dynamic"}
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="user_name_entry">{lang('User_Name')}:<font color="#ff0000">*</font></label>
                                <div class="col-sm-7">
                        ...
                        {/if}
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="password">{lang('password')}:<font color="#ff0000">*</font></label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input tabindex="11" type="text" maxlength="32"  name="first_name" id="first_name"  autocomplete="Off"  minlength="3" class="form-control"  {if isset($reg_post_array['first_name'])} value="{$reg_post_array['first_name']}" {/if} />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input tabindex="12"  type="text"   name="last_name" id="last_name"  maxlength="32"autocomplete="Off" minlength="3" class="form-control" {if isset($reg_post_array['last_name'])} value="{$reg_post_array['last_name']}" {/if} >
                                {if isset($error['last_name'])}<span class='val-error' >{$error['last_name']} </span>{/if}
                            </div>
                        </div>
                        <div class="form-group">
                            <label class=" col-sm-3 control-label" for="gender">{lang('gender')}:<font color="#ff0000">*</font></label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="date_of_birth">{lang('date_of_birth')}:<font color="#ff0000">*</font> </label>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="address">{lang('adress_line1')}:<font color="#ff0000">*</font></label>
                            <div class="col-sm-7">
                                <input   tabindex="17" type="text" maxlength="32"  name="address" id="address"  maxlength="128"autocomplete="Off"  class="form-control" {if isset($reg_post_array['address'])} value="{$reg_post_array['address']}" {/if} >
                                {if isset($error['address'])}<span class='val-error' >{$error['address']} </span>{/if}
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="address_line2">{lang('adress_line2')}:</label>
                            <div class="col-sm-7">
                                <input  tabindex="18" type="text" maxlength="32"  name="address_line2" id="address_line2"  maxlength="128"autocomplete="Off"  class="form-control"  {if isset($reg_post_array['address_line2'])} value="{$reg_post_array['address_line2']}" {/if} >

                                {if isset($error['address_line2'])}<span class='val-error' >{$error['address_line2']} </span>{/if}
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="pin">{lang('zip_code')}:</label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            <label class=" col-sm-3 control-label" for="country">{lang('country')}:<font color="#ff0000">*</font></label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">                  
                            <label class=" col-sm-3 control-label" for="">{lang('state')}:</label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="city">{lang('city')}:<font color="#ff0000">*</font></label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-sm-3 control-label" for="email">{lang('email')}:<font color="#ff0000">*</font></label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            ...
                            <label class=" col-sm-3 control-label" for="land_line">{lang('land_line_no')}:</label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            <label class=" col-sm-3 control-label" for="mobile">{lang('mobile_no')}:<font color="#ff0000">*</font></label>
                            <div class="col-sm-8 row">
                                <div class="col-sm-2">
                                    <input  tabindex="25" name="mobile_code" readonly="" id="mobile_code" {if $reg_count>0}value="{$reg_post_array['mobile_code']}"{/if} type="text" autocomplete="Off" class="form-control" maxlength="10">
                                </div> 
                                <div class="col-sm-9">
                                    <input  tabindex="26" name="mobile" id="mobile" type="text" autocomplete="Off" class="form-control" maxlength="15" {if $reg_count>0} value="{$reg_post_array['mobile']}" {/if} >
                        ...
                        <div class="form-group">
                            ...
                            <label class=" col-sm-3 control-label" for="bank_name">{lang('bank_name')}:</label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            <label class=" col-sm-3 control-label" for="bank_branch">{lang('branch_name')}:</label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            <label class=" col-sm-3 control-label" for="bank_acc_no">{lang('bank_account_number')}:</label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="ifsc">{lang('ifsc_code')}:</label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-sm-7" for="">    
                                ...
                                <label class="checkbox-inline">
                                    <input name="agree" id="agree"  type="checkbox"  tabindex="32">
                        ...
                        <div class="form-group">
                            <div class="col-sm-2 col-sm-offset-3">
                                <button tabindex="33" class="btn btn-dark-grey back-step btn-block" style="margin-bottom: 10px;">
                            ...
                            <div class="col-sm-2 col-sm-offset-3">
                                ...
                                <button tabindex="34" class="btn btn-blue next-step btn-block"  id="next_2">
                                    {lang('next')} <i class="fa fa-arrow-circle-right"></i>
                                </button> 
                            </div>
                        </div>
                        ...
                        <div class="tabbable ">
                            <ul id="myTab3" class="nav nav-tabs tab-green">                                    
                                ...
                                {if $payment_methods_tab}
                                    ...
                                    {*                                        {$epdq_status = $payment_gateway_array['epdq_status']}*}
                                    {*                                        {$authorize_status = "no"}*}
                                    {$epdq_status = "no"}
                                    ...
                                    {else}
                                        ...
                                        {else if  $payment_gateway_status == "yes" && $epdq_status == 'yes'}
                                            {$active_tab_val="epdq_tab"}
                                    ...
                                    {if $payment_pin_status == "yes" && $MODULE_STATUS['pin_status'] == "yes"}
                                        <li {if $active_tab_val=='epin_tab'}class="active"{/if} id="epin_tab">
                                            <a href="#panel_tab4_example2" data-toggle="tab">
                                                <i class="blue fa fa-user"></i>{lang('epin')}
                                            </a>
                                        </li>
                                    {/if}
                                    {if $payment_ewallet_status== 'yes'}
                                        <li {if $active_tab_val=='ewallet_tab'}class="active"{/if}id="ewallet_tab">
                                            <a href="#panel_tab4_example3" data-toggle="tab">
                                                <i class="blue fa fa-user"></i>{lang('ewallet')}
                                            </a>
                                        </li>
                                    {/if}
                                    {if $payment_gateway_status == "yes" && $paypal_status == "yes"}
                                        <li {if $active_tab_val=='paypal_tab'}class="active"{/if}  id="paypal_tab">
                                            <a href="#panel_tab4_example4" data-toggle="tab">
                                                <i class="pink fa fa-dashboard"> </i>{lang('paypal')}
                                            </a>
                                        </li>
                                    {/if}
                                    {if $epdq_status == 'yes'}
                                        <li {if $active_tab_val=='epdq_tab'}class="active"{/if} id="epdq_tab">
                                            <a href="#panel_tab4_example6" data-toggle="tab">
                                                <i class="pink fa fa-dashboard"> </i>{lang('epdq')}
                                            </a>
                                        </li>
                                    {/if}
                                    {if $authorize_status == 'yes'}
                                        <li {if $active_tab_val=='authorize_tab'}class="active"{/if} id="authorize_tab">
                                            <a href="#panel_tab4_example7" data-toggle="tab">
                                                <i class="pink fa fa-dashboard"> </i>{lang('authorize')}
                                            </a>
                                        </li>
                                    {/if}
                                    {if $free_joining_status == 'yes'}
                                        <li  {if $active_tab_val=='free_join_tab'}class="active"{/if} id="free_join_tab">
                            ...
                            <div class="tab-content">
                                ...
                                {if $payment_methods_tab} 
                                    ...
                                    {include file="register/validate_epin_script.tpl"  name=""}
                                        <div class="tab-pane {if $active_tab_val=='epin_tab'}active{/if}"  id="panel_tab4_example2">

                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <i class="fa fa-external-link-square">{lang('epin')}</i>
                                                </div>
                                                <div class="panel-body">
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                                    ...
                                                                    <tbody>
                                                                            ...
                                                                            {for $i=1 to $pin_count}
                                                                                <tr   align="center" >
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="col-md-12">
                                                                                            <p>
                                                                                                <input  style="width:200px" tabindex="55" type="text" name="epin{$i}" id="epin{$i}" size="20"   autocomplete="Off"   class="form-control" onblur="check_epin_submit();" value="{$reg_post_array["epin{$i}"]}"/>
                                                                                    ...
                                                                                    <td> <div class="col-md-12">
                                                                                            <input tabindex="56" type="text" name="pin_amount{$i}" id="pin_amount{$i}" size="20"   autocomplete="Off"   class="form-control" readonly value="{$reg_post_array["pin_amount{$i}"]}"/>  
                                                                                            <span id="pin_amount_span" style="display:none;"></span>

                                                                                        </div>
                                                                                    </td>
                                                                                    <td><div class="col-md-12">
                                                                                            <input tabindex="57" type="text" name="remaining_amount{$i}" id="remaining_amount{$i}" size="20"   autocomplete="Off"   class="form-control" readonly value="{$reg_post_array["remaining_amount{$i}"]}"/>  
                                                                                            <span id="remain_amount_span" style="display:none;"></span>

                                                                                        </div>
                                                                                    </td>
                                                                                    <td><div class="col-md-12">
                                                                                            <input tabindex="58" type="text" name="$i}" id="balance_amount{$i}" size="19"   autocomplete="Off"   class="form-control" readonly value="{$reg_post_array["balance_amount{$i}"]}"/>  
                                                                        ...
                                                                        {else}
                                                                            <tr   align="center" id=""epin_raw1>
                                                                                ...
                                                                                <td><div class="col-md-12">
                                                                                        <p>
                                                                                            <input  style="width:200px" tabindex="55" type="text" name="epin1" id="epin1" size="20"   autocomplete="Off"   class="form-control" onblur="check_epin_submit();"/>  
                                                                                ...
                                                                                <td><div class="col-md-12">
                                                                                        <input tabindex="57" type="text" name="remaining_amount1" id="remaining_amount1" size="20"   autocomplete="Off"   class="form-control" readonly/>  
                                                                                        <span id="remain_amount_span" style="display:none;"></span>

                                                                                    </div>
                                                                                </td>
                                                                                <td><div class="col-md-12">
                                                                                        <input tabindex="58" type="text" name="balance_amount1" id="balance_amount1" size="19"   autocomplete="Off"   class="form-control" readonly/>  
                                                                                        <span id="balance_amount_span" style="display:none;"></span>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                        ...
                                                        <div class="form-group"> 
                                                            <div class="col-md-8">
                                                                <div class="col-md-4">
                                                                    <label class="  control-label" for="tt">{lang('total_amount')}:</label></div>
                                                                <div class="col-md-8">
                                                            ...
                                                            <div class="col-md-4" id="validate_epin_div">
                                                                <input type="button" id ="pin_btn" name= "pin_btn" value = "{lang('epin_val')}" onclick="validate_epin();" tabindex="60" class="btn btn-bricky"/> 
                                                            </div>
                                                        </div> 
                                                        ...
                                                        <div class="form-group"id="finButtn">
                                                            ...
                                                            <div class="col-sm-2 col-sm-offset-8">
                                                                <button class="btn btn-blue btn-block" name="epin_submit" id="epin_submit" disabled="">
                                    ...
                                    {/if}
                                    {if $payment_ewallet_status== 'yes'}
                                        <div class="tab-pane {if $active_tab_val=='ewallet_tab'}active{/if}"  id="panel_tab4_example3">

                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <i class="fa fa-external-link-square">{lang('ewallet')}
                                                    </i>
                                                </div>
                                                ...
                                                <div class="panel-body">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="col-sm-3 control-label" for="user_name_ewallet">{lang('User_Name')}:<font color="#ff0000">*</font></label>
                                                            <div class="col-sm-7">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label" for="tran_pass_ewallet">{lang('transaction_password')}:<font color="#ff0000">*</font></label>
                                                            <div class="col-sm-7">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-12 ">
                                                            <div class="col-sm-2 col-sm-offset-8" id="check_ewallet_button">
                                                                <input type="button" id ="ewallet_btn" name= "ewallet_btn" value = "Check Availability" onclick="validate_ewallet();" tabindex="60" class="btn btn-bricky" style="margin-top: 9%;margin-left: 9%;"/> 
                                                            </div> 
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-2 col-sm-offset-8">
                                                            <button class="btn btn-blue btn-block" name="ewallet_submit" id="ewallet_submit" disabled="">
                                                                {lang('finish')} <i class="fa fa-arrow-circle-right"></i>
                                                            </button>  
                                                        </div>
                                                    </div>
                                    ...
                                    {if $paypal_status == "yes"} 
                                        <div class="tab-pane {if $active_tab_val=='paypal_tab'}active{/if}" id="panel_tab4_example4">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <i class="fa fa-external-link-square">{lang('paypal')}
                                                    </i>
                                                </div>
                                    ...
                                    {/if}
                                    {if $epdq_status == 'yes'}
                                        <div class="tab-pane {if $active_tab_val=='epdq_tab'}active{/if}"   id="panel_tab4_example6">

                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <i class="fa fa-external-link-square">{lang('epdq')}
                                                    </i>
                                                </div>
                                    ...
                                    {/if}
                                    {if $authorize_status == 'yes'}
                                        <div class="tab-pane {if $active_tab_val=='authorize_tab'}active{/if}"  id="panel_tab4_example7">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <i class="fa fa-external-link-square">{lang('authorize')}
                                                    </i>
                                                </div>
                                    ...
                                    {/if}
                                    {if $free_joining_status == 'yes'}
                                        <div class="tab-pane {if $active_tab_val=='free_join_tab'}active{/if}"  id="panel_tab4_example5">
