            ...
            <ul class="nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu posts">
                        ...
                        {else}
                            <li>
                                <span id="unread_mail" class="dropdown-menu-title"> You have no new mail</span>
                            </li>
                        {/if}
                        <li class="view-all">
                            <a href="{$BASE_URL}user/mail/mail_management">
...
<div class="main-container">
    <div class="navbar-content">
        ...
        <div class="main-navigation navbar-collapse collapse">
            ...
            {include file="user/layout/themes/default/menu.tpl" title="Example Smarty Page" name=""}
        </div>
        <!-- end: SIDEBAR -->
    </div>
    <!-- start: PAGE -->
    <div class="main-content" >
        <div class="container" style="background-color: white;">
            ...
            <!-- end: PAGE HEADER --> 
            {include file="user/layout/themes/default/error_box.tpl" title="" name=""}