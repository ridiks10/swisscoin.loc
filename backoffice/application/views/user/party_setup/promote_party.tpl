                    ...
                    <div class="col-sm-12">
                        <div class="panel-body">
                            <div>
                                ...
                                <br><br>
                                <a href="../create_party"><input class="btn btn-bricky" type="button" value="Setup Another Party" tabindex="2"></a> <br><br> 
                                <a href="../../myparty/party_portal"><input class="btn btn-bricky" type="button" value="Go to Party Portal" tabindex="2"></a>  
                            </div>
                        </div>
                    </div>
                </div>
