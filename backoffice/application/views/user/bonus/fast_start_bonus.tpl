    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-external-link-square"></i>Fast Start Bonus
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <center><h3>{lang('fast_start_bonus')}: {$user_name} </h3></center>
                    <table class="table table-striped table-bordered table-hover table-full-width" id=""> 
                        ...
                        {if !empty($matching_bonus_details)}
                            ...
                            {/foreach} 
                            <tr><td colspan="2" style="text-align: right"><b>{lang('amount_total')}</b></td><td><b>{$DEFAULT_SYMBOL_LEFT}{number_format($total_amount*$DEFAULT_CURRENCY_VALUE,2)}{$DEFAULT_SYMBOL_RIGHT}</b></td></tr>
                        {else}
                             <tr style="text-align: center">
                                 <td colspan="3"> {lang('no_fast_start')}</td>
