                ...
                {form_open('', 'role="form" class="smart-wizard form-horizontal" name="searchform" id="searchform" method="post"')}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input class="form-control" type="hidden" id="bonus_type" name="bonus_type" value="direct_bonus">
    ...
    <div class=" row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <center><h3>{lang('direct_bonus')} : {$user_name} </h3></center>
                    <table class="table table-striped table-bordered table-hover table-full-width" id=""> 
                        ...
                        {if !empty($direct_bonus_details)}{assign var="i" value=1}
                            {foreach from=$direct_bonus_details item=v}
                                ...
                                {$i=$i+1}
                            {/foreach} 
                            <tr><td colspan="2" style="text-align: right"><b>{lang('amount_total')}</b><td><b>{$DEFAULT_SYMBOL_LEFT}{number_format($total_amount*$DEFAULT_CURRENCY_VALUE,2)}{$DEFAULT_SYMBOL_RIGHT}</b></td></tr>
                        {else}
                             <tr style="text-align: center">
                                 <td colspan="3"> {lang('not_found')}</td>
