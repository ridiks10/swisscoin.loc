    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form name="guest" id="guest" method="post" action="">
                    ...
                    <div class="form-group" >
                        <div class="col-sm-2 col-sm-offset-1">
                            <button class="btn btn-bricky" tabindex="1" name="sent_evite" id="sent_evite"  type="submit"  value="Sent E-vite" >{lang('sent_e_vite')} </button>
                        </div>
