        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div >   
                    ...
                    <div class="buttons">                
                        <a href="{$BASE_URL}user/purchase/product_purchase"><input type="button" value="Continue Shopping" id="button-login" data-loading-text="Loading..." class="pull-left btn111 btn-add" style="padding: 7px 25px 7px 25px;background: #3276b1;border: 0px solid #000 !important;margin: 9px 10px 10px 0px;color: white;" /></a>
                            
                        <a href="{$BASE_URL}user/purchase/confirm"><input type="button" value="Checkout" name="checkout" id="checkout" data-loading-text="Loading..." class="pull-right btn111 btn-add" style="padding: 7px 25px 7px 25px;background: #3276b1;border: 0px solid #000 !important;margin: 9px 10px 10px 0px;color: white;" {if (isset($KYC_status))}disabled="disabled"{/if} /></a>
                            
                        <a href="{$BASE_URL}user/purchase/clearCart"><input type="button" value="Clear Cart" id="button-login" data-loading-text="Loading..." class="pull-right btn111 btn-add" style="padding: 7px 25px 7px 25px;background: #d2322d;border: 0px solid #000 !important;margin: 9px 10px 10px 0px;color: white;" /></a>
                    </div>
                    {if (isset($KYC_status))}
                        <div class="clearfix"></div>
                        <p class="bg-missing">You cannot make a purchase on € 100 or more without KYC verification</p>
                    {/if}
                     {else}
                    <style>
                        .footer{
