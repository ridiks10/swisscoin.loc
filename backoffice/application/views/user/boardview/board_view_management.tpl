                        ...
                        <tbody>
                            {foreach from=$user_board item=v}
                                ...
                                <tr {$class} >
                                    ...
                                    <td>{$split_Status}</td>
                                    <td>
                                        <a id="element_1" href="{$BASE_URL}user/tree/board_view/{$table_no}/{$encr_id}"   toptions="width = 1000, height = 500, type = iframe, title ={lang('Club_View')}, layout = quicklook, shaded = 1" target="_blank">
