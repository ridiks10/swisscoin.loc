...
<div class="content">
<p>
{lang('total_joining')} : <redspan>{$total_joining}</redspan>
</p>
<p>
{lang('today_joining')} : <redspan>{$todays_joining}</redspan>
</p>
</div>
</div>
</div>
...
<div class="content">
<p>
{lang('total_amount')}  : <redspan>{$DEFAULT_SYMBOL_LEFT}{round($total_amount,2)*$DEFAULT_CURRENCY_VALUE}{$DEFAULT_SYMBOL_RIGHT}</redspan>
</p>
{if $MODULE_STATUS['payout_release_status'] == "ewallet_request"}
<p>
{lang('total_requested')} : <redspan>{$DEFAULT_SYMBOL_LEFT}{round($requested_amount,2)*$DEFAULT_CURRENCY_VALUE}{$DEFAULT_SYMBOL_RIGHT}</redspan>
</p>
{/if}
<p>
{lang('total_relesed')} : <redspan>{$DEFAULT_SYMBOL_LEFT}{round($total_released,2)*$DEFAULT_CURRENCY_VALUE}{$DEFAULT_SYMBOL_RIGHT}</redspan>
</p>
...
<div class="content">
<p>
{lang('total')}  : <redspan>{$total_pin}</redspan>
</p>
<p>
{lang('used')} : <redspan>{$used_pin}</redspan>
</p>
<p>
{lang('requested')} : <redspan>{$requested_pin}</redspan>
</p>
</div>
</div>
</div>
...
<div class="content">
<p>
{lang('read')} : <redspan>{$read_mail}</redspan>
</p>
<p>
{lang('unread')} : <redspan>{$unread_mail}</redspan>
</p>
<p>
{lang('today')} : <redspan>{$mail_today}</redspan>
</p>
</div>
</div>
</div>
...
{if (isset($kyc_status))}
    <p class="bg-{$kyc_status}">{$kyc_message}</p>
{/if}
...
<div class="row"><!---dash box start---->
    ...
    <div class="col-lg-3 col-md-3">
        <div class="panel panel-gray" style="border-radius: 0px;  border: 1px solid rgb(91, 91, 91); ">
            ...
            <a href="{$BASE_URL}user/tokens/more">
    ...
    <div class="col-lg-3 col-md-3">
        <div class="panel panel-gray" style="border-radius: 0px;  border: 1px solid rgb(91, 91, 91); ">
            <div class="panel-heading-4">
             ...
             <a href="{$BASE_URL}user/bonus/bonus_this_week">
...
<div class="row"><!---dash box start---->
    <div class="col-lg-3 col-md-3">
        <div class="panel panel-gray" style="border-radius: 0px;  border: 1px solid rgb(91, 91, 91); ">
            ...
            <a href="{$BASE_URL}user/bonus/bonus_from_start">
                <div class="panel-footer-1">
                    <span class="pull-left"></span>
                    <span class="pull-right"> {lang('more')}.. <i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
    ...
    <div class="col-lg-3 col-md-3">
        <div class="panel panel-gray" style="border-radius: 0px;  border: 1px solid rgb(91, 91, 91); ">
            <div class="panel-heading-2">
             ...
             <a href="{$BASE_URL}user/ewallet/my_ewallet">
                <div class="panel-footer-2">
                    <span class="pull-left"></span>
                    <span class="pull-right"> {lang('more')}.. <i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
    ...
    <div class="col-lg-3 col-md-3">
        <div class="panel panel-gray" style="border-radius: 0px;  border: 1px solid rgb(91, 91, 91); ">
            ...
            <a href="{$BASE_URL}user/cash_account/my_cash">
                <div class="panel-footer-3">
                    <span class="pull-left"></span>
                    <span class="pull-right"> {lang('more')}.. <i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
    ...
    <div class="col-lg-3 col-md-3">
        <div class="panel panel-gray" style="border-radius: 0px;  border: 1px solid rgb(91, 91, 91); ">
            ...
            <a href="{$BASE_URL}user/trading/my_trading">
                <div class="panel-footer-4">
                    <span class="pull-left"></span>
                    <span class="pull-right"> {lang('more')}.. <i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
...
<div class="row"><!---dash box start---->
    <div class="col-lg-3 col-md-3">
        <div class="panel panel-gray" style="border-radius: 0px;  border: 1px solid rgb(91, 91, 91); ">
            ...
            <a href="{$BASE_URL}user/my_report/unilevel_history">
                <div class="panel-footer-1">
                    <span class="pull-left"></span>
                    <span class="pull-right"> {lang('more')}.. <i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
            ...
            <div class="panel-heading-2">
                <div class="row">
                    ...
                    <div class="col-xs-10 text-left">
                        ...
                        <div style="font-size: 18px; padding-left: 10px">{$secondline_count}</div>
                    </div>
                </div>
            </div>
            <a href="{$BASE_URL}user/my_secondlines/second_lines">
                <div class="panel-footer-2">
                    <span class="pull-left"></span>
                    <span class="pull-right"> {lang('more')}.. <i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <a href="{$BASE_URL}../webinar/{$webinar['webinar_id']}/{$LOG_USER_NAME}" target="_blank"> <img src="{$PUBLIC_URL}images/webinar_images/{$webinar['image']}" alt="" style="width: 100%; height: 270px;"></a>
            ...
            <div class="popup-background">
                ...
                <div class="popup-content">
                    <div class="popup-inner">
                        <div id="news-{$news['news_id']}" class="news-entry">
                            <h3>{$news['news_title']}</h3>
                            {if !empty($news['news_image'])}<img src="{$PUBLIC_URL}images/news/{$news['news_image']}"/>{/if}
                            {$news['news_desc']}
                        </div>
                    </div>
                </div>
...
<script>
    ...
    {* Index.init();*}
        ...
        {if !empty($news)}
            $('#news-popup .popup-close').on('click', function(){
                $.post('{$base_url}user/ajax/setViewedNews', { news_id: {$news['news_id']} });
                $('#news-popup').hide(0);
            });
        {/if}
    });
