<div class="panel panel-default">
    ...
    <div class="panel-body"> 
            {form_open('user/mail/mail_to_downlines','role="form" class="smart-wizard form-horizontal"  method="post"  name="send_news" id="send_news"')}
            <div class="col-md-12">
            ...
            <div class="form-group" id="select_user_div" style="display: none;">
                ...
                <div class="col-sm-3">
                    <select name="username" id="username"  tabindex="12" class="form-control" >
                        ...
                        {foreach from = $user_downlines  item=users}
