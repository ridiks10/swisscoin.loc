            ...
            <div class="panel-body">
                ...
                {if $ticket_status!="Resolved"}
                    <div class="col-sm-6 col-sm-offset-5">                         
                        <a href="{$BASE_URL}admin/ticket_system/ticket/{$v.ticket_id}" target="_blank"> <button class="btn btn-bricky blue" type="submit" name="reply"  id="referal_details" value="" style="width:25%;">{lang('reply')}</button></a>
                    </div>
                {/if}
            </div> 
        </div> 
