    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-external-link-square"></i> {lang('activate_deactivate_report')}
            ...
            <div  id="print_area" style="overflow: auto; max-height:1000px;">
                ...
                {if $count >= 1}
                    <br><br><table border='1' cellpadding='5px' cellspacing='0'align='center' width="100%">
                        <tr>
                            <td colspan = '19'><a href={$BASE_URL}admin/excel/create_excel_activate_deactivate_report_view>{lang('create_excel')}</a></td>
                        </tr>
                        <tr class='th'>
                            <th>{lang('no')}</th>
                        ...
                        {foreach from=$activate_deactive item=v}                      
                            {$i=$i+1}
                            <tr class>
                                <td>{$i}</td>
                                <td>{$v.user_name}</td>
