    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div  id="print_area" style="overflow: auto; max-height:1000px;">
                ...
                {if $count >= 1}
                    <a href={$BASE_URL}admin/excel/create_excel_product_sales_report>{lang('create_excel')}</a>
                    ...
                    <br><br><table border='2' cellpadding='5px' cellspacing='0' align='center' width="100%" >
                        ...
                        {foreach from=$sales_report_arr item=v}
                            ...
                            <tr{$class}>
                                ...
                                <td>{$DEFAULT_SYMBOL_LEFT}{number_format($v.amount*$DEFAULT_CURRENCY_VALUE,2)}{$DEFAULT_SYMBOL_RIGHT}{$total=$total+$v.amount}</td>
                            </tr>
                        {/foreach}
                        <tr><td colspan="5" style="text-align: right">{lang('total_amount')}</td><td>{$DEFAULT_SYMBOL_LEFT}{number_format($v.sum*$DEFAULT_CURRENCY_VALUE,2)}{$DEFAULT_SYMBOL_RIGHT}{$total=$total+$v.amount}</td></tr>
                            {else}
