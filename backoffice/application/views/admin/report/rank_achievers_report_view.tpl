...
{assign var="report_name" value="{lang('rank_achieve_report')}"}
            ...
            <div  id="print_area" style="overflow: auto; max-height:1000px;">
                ...
                {if $count >= 1}
                    <br><br><table border='1' cellpadding='5px' cellspacing='0' align='center' width='100%'>
                        <tr>
                            <td colspan = '19'><a href={$BASE_URL}admin/excel/create_excel_rank_achievers_report>{lang('create_excel')}</a></td>
                        </tr>
                        <tr class='th'>
                            <th>{lang('slno')}</th>
                            <th>{lang('new_rank')}</th>
