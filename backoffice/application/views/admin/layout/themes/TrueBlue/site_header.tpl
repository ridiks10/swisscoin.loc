...
<div class="dashboard-wrapper">
    ...
    <aside id="sidebar" style="height:100%">
        ...
        <div id='menu'  style="background: #398ab9;  ">
            {include file="admin/layout/themes/TrueBlue/menu.tpl" title="user_menu" name=""}           
        </div>
    </aside>
    <!-- Left sidebar end -->
                ...
                <li class="list-box hidden-xs dropdown">
                    ...
                    <ul class="dropdown-menu sm fadeInUp animated messages">
                        <li class="dropdown-content">
                            <a href="{$BASE_URL}admin/profile/profile_view">{lang('profile_management')}</a>
                            <!--<a href="#">Settings</a>-->
    ...
    <div class="main-container" style="min-height:871px">
            ...
            <div class="page-title" style="width: 100%;">
                <div class="row">
                    <div class="col-sm-12">
                        <ol class="tabs"> 
                            <h4>
                                <div class="fs1" aria-hidden="true" data-icon="&#xe0a0;"></div><a href="{$BASE_URL}admin/home/index" class="samll">{lang('dashboard')}</a>
                                ...
                                {/if}
                                {if $HELP_STATUS==='yes'}
                                    <li style="font-size: 14px; list-style: none; display: inline;">
                                ...
                                <li class="pull-right date_blue" style="font-size: 14px; list-style: none;">
        ...
        <div class="container-fluid">
            <!-- Spacer starts -->
            <div class="spacer-xs" id="page_container">
                <!-- end: PAGE HEADER --> 
                {include file="admin/layout/themes/TrueBlue/error_box.tpl" title="" name=""}