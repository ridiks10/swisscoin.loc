...
<!-- end: MAIN CONTAINER -->
{include file="admin/layout/themes/default/chat.tpl" title="" name=""}
...
<div class="footer clearfix">
    ...
    <div class="footer-inner">
        ...
        {/if}
        <a data-toggle="modal" style="padding-left: 10px;color:#fff;text-decoration: underline;cursor:pointer;" data-target="#panel-config">AGB</a>
        <a data-toggle="modal" style="padding-left: 10px;color:#fff;text-decoration: underline;cursor:pointer;" data-target="#impressum-config">{lang('impressum')}</a>
    </div>
...
{include file="admin/layout/themes/default/modals.tpl" title="" name=""}