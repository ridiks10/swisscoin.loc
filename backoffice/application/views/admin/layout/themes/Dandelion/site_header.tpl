    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{$BASE_URL}admin/home/index">
                <img src="{$PUBLIC_URL}images/logos/{$site_info['logo']}" style="width: 91px;margin-top: 0px;position: absolute;" />
            </a>
            {* end: LOGO *}
        </div>
...
<div class="main-container">
    ...
    <div class="navbar-content">
        <div class="main-navigation navbar-collapse collapse">
            ...
            {include file="admin/layout/themes/Dandelion/menu.tpl" title="Example Smarty Page" name=""}
        </div>
    </div>
    <!-- end: SIDEBAR -->
        ...
        <div class="container"  id="page_container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="page-header page-header-date1" style="margin: 0px 0 23px;">
                        <ol class="breadcrumb">
                            <li>
                            ...
                            {if $HELP_STATUS==='yes'}
                                <li>
                                    <a href="https://infinitemlmsoftware.com/help" target="_blank" class="clip-info help_top_icon" title="{lang('click_here_to_see_more_help_on_this_page')}"></a>                                                          
                                </li>
                            {/if}	
                            <!-- start: TIME -->
                            <li class="pull-right">		
            ...
            <!-- end: PAGE HEADER --> 
            {include file="admin/layout/themes/Dandelion/error_box.tpl" title="" name=""}
