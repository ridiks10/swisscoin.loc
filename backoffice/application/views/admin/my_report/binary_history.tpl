            ...
            <div class="panel-body" style="overflow-x: hidden;"> 
                ...
                <div class="row">
                    <div class="form-group"  > 
                        ...
                        <div class="col-sm-3">                                    
                            <input  name="user_name" id="user_name" type="text" size="23" onkeyup="ajax_showOptions(this, 'getCountriesByLetter', event)" autocomplete="off" tabindex="1" style="width: 208px;" {if isset($username)} value="{$username}" {/if} >
                ...
                {if isset($username)}
                    <div class ="row">
                        <div class ="col-sm-12 center">
                            <h3>{lang('binary_history')}: {$username}</h3>
                        </div>
                    </div>
                {/if}
                {if count($binary)>0}
