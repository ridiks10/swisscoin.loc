    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                {form_open_multipart('', 'name="setup_party" id="setup_party" method="POST" class="smart-wizard form-horizontal"')}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div id="select_host" class="space">
                                                <select name="host_id" id="host_id" class="form-control" tabindex="4" style="width: 200px"/>
