    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-external-link-square"></i> {lang('activate_deactivate_report_dialy')}
            ...
            <div class="panel-body">
                {form_open('admin/report/activate_deactivate_daily','role="form" class="smart-wizard form-horizontal"  method="post"  name="daily" id="daily" target="_blank"')}
                    <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            </div>{if $error_count_activeInactive && isset($error_array_actveInactive['date'])}{$error_array_actveInactive['date']}{/if}
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-external-link-square"></i>{lang('activate_deactivate_report_weekely')}
                <div class="panel-tools">
                    <a class="btn btn-xs btn-link panel-collapse collapses" href="#">
                    </a>
                    <a class="btn btn-xs btn-link panel-refresh" href="#">
            ...
            <div class="panel-body">
                {form_open('admin/report/activate_deactivate_report_view','role="form" class="smart-wizard form-horizontal" method="post"   name="weekly_join" id="weekly_join"  target="_blank"')}
                    <div class="col-md-12">
                        <div class="errorHandler alert alert-danger no-display">
                            <i class="fa fa-times-sign"></i> {lang('errors_check')}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            </div>{if $error_count_activeInactive && isset($error_array_actveInactive['week_date1'])}{$error_array_actveInactive['week_date1']}{/if}
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            </div>{if $error_count_activeInactive && isset($error_array_actveInactive['week_date2'])}{$error_array_actveInactive['week_date2']}{/if}
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2 col-sm-offset-2">

                            <button class="btn btn-bricky"tabindex="5" name="submit_active_deactive" type="submit" value="{lang('submit')}"> {lang('submit')}</button>
