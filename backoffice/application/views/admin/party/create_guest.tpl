    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-external-link-square"></i> {lang('add_new_guest')}
            ...
            <div class="panel-body">
                {form_open('', 'role="form" class="smart-wizard form-horizontal"  method="post"    name="create_guest" id="create_guest"')}
                    <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" name="firstname" id="firstname" tabindex="1" {if isset($create_guest_arr['firstname'])} value="{$create_guest_arr['firstname']}" {else} value="{$first_name}" {/if}/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" name="lastname" id="lastname"  tabindex="2" {if isset($create_guest_arr['lastname'])} value="{$create_guest_arr['lastname']}" {else} value="{$last_name}"{/if}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <textarea rows="4" name="address" id="address"  cols="20" style="background-color:#ffffff;  border:1px; border-style:solid;border-color:#d6d6d6;" tabindex="3">{if isset($create_guest_arr['lastname'])} {$create_guest_arr['address']} {else} {$address}{/if}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <select name="country" id="country" class="form-control" tabindex="4" onChange="getAllStatessSetup(this.value)">
                                {if isset($create_guest_arr['country'])} 
                                    <option value="{$create_guest_arr['country']}" selected>{$create_host_arr['country_name']}</option>                                                   
                                {else if $country==""}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" name="city" id="city" tabindex="6" {if isset($create_guest_arr['city'])} value="{$create_guest_arr['city']}" {else} value="{$city}" {/if}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" name="zip" id="zip" tabindex="7" maxlength="6" {if isset($create_guest_arr['zip'])} value="{$create_guest_arr['zip']}" {else} value="{$zip}"{/if}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" name="phone" id="phone" tabindex="8" maxlength="10" {if isset($create_guest_arr['phone'])} value="{$create_guest_arr['phone']}" {else} value="{$phone}" {/if}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" name="email" id="email" tabindex="9" {if isset($create_guest_arr['email'])} value="{$create_guest_arr['email']}" {else} value="{$email}" {/if}>
                    ...
                    {else}
                        ...
                        <div class="form-group"  style="float: left; width: 255px;">
                            <div class="col-sm-2 col-sm-offset-8">
                                <button class="btn btn-bricky" tabindex="12" name="submit" id="submit"  type="submit"  value="Add Host" >{lang('add_customer')} </button>
                            </div>
                        </div>
                        ...
                        <div class="form-group"  style="float: left; text-align: left; width: 150px;">
                            <div class="col-sm-2 col-sm-offset-9">
                                <a href="guest_manager">
                                    <button class="btn btn-light-grey" tabindex="13"  name="cancel" id="cancel" type="button" value="Cancel" >{lang('cancel')}</button></a>
                            </div>
                        </div>                              
                    {/if}  
                {form_close()}
