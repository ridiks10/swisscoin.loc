...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input tabindex="20" maxlength="50" type="text" name ="video[title]" id ="title" title="" class="form-control" value="" >{form_error('video[title]')}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input tabindex="21" type="text" name ="video[url]" id ="url" title="" class="form-control" value="" >{form_error('video[url]')}
        ...
        <div class="form-group">
            <div class="col-sm-2 col-sm-offset-2">
                <button class="btn btn-bricky"  type="submit" tabindex="32" name="setting" id="setting" style="margin-left:25%;" title="{lang('update')}" >{lang('update')}</button>
            </div>
        </div>
        {form_close()}
    </div>
