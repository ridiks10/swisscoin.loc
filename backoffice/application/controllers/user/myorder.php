...
class myorder extends Inf_Controller {
    ...
    function order_history($page = 1) {
        ...
        $pagination['base_url'] = base_url() . "user/myorder/order_history";
        $pagination['num_links'] = 5;
        $pagination['per_page'] = 100;
        $pagination['total_rows'] = $this->myorder_model->getCountOrders($this->LOG_USER_ID);
        $this->pagination->initialize($pagination);
        
        $package_details = $this->myorder_model->getMyOrders($this->LOG_USER_ID, $page);
