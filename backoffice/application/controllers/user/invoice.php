...
//        $title = lang('order_details');
        $title = 'Invoice';
        $this->set("title", $this->COMPANY_NAME . " | Invoice");

        $this->HEADER_LANG['page_top_header'] = 'Invoice';
        $this->HEADER_LANG['page_top_small_header'] = '';
        $this->HEADER_LANG['page_header'] = 'Invoice';
        ...
        $order_details = $this->invoice_model->getUserOrderDetails($user_id);
