...
class nusoap_client extends nusoap_base  {
	...
	*/
	...
	function loadWSDL() {
		...
		$this->wsdl = new wsdl('',$this->proxyhost,$this->proxyport,$this->proxyusername,$this->proxypassword,$this->timeout,$this->response_timeout,$this->curl_options,$this->use_curl);//unc
