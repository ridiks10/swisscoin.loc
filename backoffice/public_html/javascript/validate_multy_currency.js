...

{
    ...
    {
        document.location.href = path_root + 'admin/currency/edit_currency/' + id;
    }
}
...
$(document).ready(function()
{
    ...
    $("#currency_title").keypress(function(e)
    {
        ...
        if( flag==1){
            ...
            $("#errmsg1").html("Alphabets Only ").show().fadeOut(1200, 0);
            return false;
        }
    });
    $("#currency_code").keypress(function(e)
    {
        ...
        {
            //display error message
            $("#errmsg2").html("Alphabets Only ").show().fadeOut(1200, 0);
            return false;
        }
    });
    $("#currency_value").keypress(function(e)
    {
        var flag=0;
        if(e.which == 46){
            if($(this).val().indexOf('.') != -1){
